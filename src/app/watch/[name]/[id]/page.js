  ...
  useEffect(() => {
    async function getEpisodeData() {
      const res = await fetch(
        `https://api.consumet.org/anime/gogoanime/${encodeURIComponent(anime)}/episodes`,
        { cache: "no-store" }
      );
    ...
    async function getEpisodeWatch() {
      const res = await fetch(
        `https://api.consumet.org/anime/gogoanime/watch?episodeId=${encodeURIComponent(
          watch
        )}`,
        { cache: "no-store" }
      );
    ...
    async function getAniData() {
      const res = await fetch(
        `https://api.consumet.org/anime/gogoanime//${encodeURIComponent(anime)}`,
        { cache: "no-store" }
      );
      const data = await res.json();
      return data;
